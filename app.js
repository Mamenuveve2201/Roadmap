...
const TRACKS = [
...

  {
    ...
    color: '#ec4899',
    desc: '5 styles by Dec 31 · Knotless + Box concurrent from Jul 1',
    targetHours: 46,
    weeklyHours: 1.5,
    startDate: '2026-07-01',
    endDate: '2026-08-23',
...

  {
    ...
    weeks: [
      {
        label: 'Month 1 — Odin Foundations + HTML/CSS Course',
        dates: 'Jun 17–30',
        tasks: [
          'The Odin Project: Foundations course — skim/skip lessons you already know',
          'The Odin Project: HTML & CSS course — Box Model, Flexbox, Grid lessons',
          'Odin project: Landing Page (flexbox)',
          'Odin project: Sign-up Form (semantic HTML + validation)',
          'CSS: variables, calc(), clamp(), responsive units (supplement if Odin doesn\'t cover deeply)',
          'CSS: media queries + mobile-first design',
        ]
      },
      {
        label: 'Month 2 — Odin JavaScript Course (Core)',
        dates: 'Jul 1–31',
        tasks: [
          'The Odin Project: JavaScript course — Fundamentals Part 1–5',
          'Odin project: Rock Paper Scissors',
          'Odin project: Etch-a-Sketch',
          'The Odin Project: JS course — Arrays, Objects, Loops sections',
          'Odin focus area: closures, prototypes, `this` binding (genuinely new — go slow here)',
          'async/await + fetch + error handling',
          'Odin project: Working with APIs (e.g. weather app)',
        ]
      },
      {
        label: 'Month 3 — Odin JS Advanced + PWA Patterns',
        dates: 'Aug 1–31',
        tasks: [
          'The Odin Project: JS course — Classes, Testing, Webpack/bundling sections',
          'Odin project: Library App or Todo List (with testing)',
          'Service workers: install, fetch, cache strategies (already familiar — quick review)',
          'Web App Manifest: all fields, icon sizes (already familiar — quick review)',
          'Modules: import/export, dynamic import()',
          'Build: Apply one new Odin pattern (e.g. testing or bundling) to an existing PWA',
        ]
      },
      {
        ...
        dates: 'Sep 1–30',
        tasks: [
          'The Odin Project: finish any remaining JS course lessons/projects',
          'WebSockets: connect, send, onmessage basics',
          'Intersection Observer: lazy loading, scroll animations',
          'Refactor one of your existing PWA apps using new Odin patterns',
...

  {
    ...
    targetHours: 0, weeklyHours: 0, startDate: '2026-07-01', endDate: '2026-12-21', weeks: []
  },
  {
    ...
    weeks: [
      {
        ...
        dates: 'Jun 17–30',
        tasks: [
          'Download CompTIA SY0-701 Exam Objectives PDF — comptia.org',
          'Professor Messer free video series: Threats, Attacks & Vulnerabilities',
          'Jason Dion Udemy course: Modules 1–50',
          'Practice questions: ExamTopics — Threats domain',
          'Flashcards: Port numbers (memorize top 20)',
          'CyberJames YouTube: Domain 1 walkthrough',
        ]
      },
      {
        label: 'Week 3–4 — Architecture + Implementation',
        dates: 'Jul 1–14',
        tasks: [
          'Professor Messer: Architecture and Design domain',
          'Jason Dion: Modules 51–130',
          'Practice questions: ExamTopics — Architecture domain',
          'Cyberkraft PBQ videos: Performance-based questions practice',
          'Flashcards: Cryptography concepts + algorithms',
          'CyberJames YouTube: Domain 2 + 3 walkthrough',
        ]
      },
      {
        label: 'Week 5–6 — Operations + Exam Prep',
        dates: 'Jul 15–31',
        tasks: [
          'Professor Messer: Operations, Governance domains (all remaining)',
          'Jason Dion: Complete remaining modules',
          'Full practice exam #1: Jason Dion Practice Exams Set 1',
          'Full practice exam #2: Jason Dion Practice Exams Set 2',
          'Full practice exam #3: Professor Messer practice exam',
          'Review all wrong answers — go back to source material',
          'PBQ practice: Cyberkraft all PBQ videos',
          'BOOK AND PASS EXAM ✅',
        ]
      },
    ]
    ...
    weeks: [
      {
        ...
        dates: 'Jul 1–14',
        tasks: [
          'Junior Security Analyst Intro room',
      ...
      {
        label: 'Module 2 — Cyber Threat Intelligence',
        dates: 'Jul 15–28',
        tasks: [
          'Intro to Cyber Threat Intel room',
          'Threat Intelligence Tools room',
          'Yara room',
          'OpenCTI room',
          'MISP room',
        ]
      ...
      {
        label: 'Module 3 — Network Security + Traffic Analysis',
        dates: 'Jul 29 – Aug 14',
        tasks: [
          'Traffic Analysis Essentials room',
          'Snort room',
          'Snort Challenge rooms',
          'NetworkMiner room',
          'Zeek room',
          'Zeek Exercises room',
          'Brim room',
      ...
      {
        label: 'Module 4 — SIEM + Endpoint Security',
        dates: 'Aug 15–31',
        tasks: [
          'Windows Event Logs room',
          'Sysmon room',
          'Splunk: Basics + 101 + 201 rooms',
          'Investigating with Splunk room',
          'Benign room',
          'ItsyBitsy room',
          'Complete SOC Level 1 path ✅',
          'Check rank — target Top 10%',
        ]
      },
    ]
  },
    ...
    weeks: [
      {
        ...
        dates: 'Aug 1–17',
        tasks: [
          'Stéphane Maarek Udemy course: AWS AI Practitioner Certified',
          'Rahul Trisal Udemy course: AWS Certified AI Practitioner (beginner to advanced)',
          'Focus areas: Amazon Bedrock, SageMaker, Amazon Q',
          'AWS Skill Builder: free official practice question set (AIF-C01)',
          'Tutorials Dojo (Jon Bonso): AIF-C01 practice exams',
          'Maarek Udemy: AI Practitioner practice exams',
          'Jayendra Patil learning path: last-minute revision',
          'Register promo code for 50% off exam fee',
          'BOOK AND PASS EXAM ✅ Aug 17 (unlocks free Cloud Practitioner + 50%-off voucher for next AWS exam)',
        ]
      },
    ]
  },
    ...
    weeks: [
      {
        ...
        dates: 'Aug 18–31',
        tasks: [
          'Claim free Cloud Practitioner voucher (issued after AI Practitioner pass)',
          'Skim AWS Cloud Practitioner Essentials (free AWS Skill Builder course)',
          'Tutorials Dojo: CLF-C02 practice questions (spot-check weak areas)',
          'Review AWS pricing, support plans, shared responsibility model',
          'BOOK AND PASS EXAM ✅ Aug 31 — must complete by Nov 30, 2026',
        ]
      },
    ]
  },
    ...
    weeks: [
      {
        ...
        dates: 'Sep 1–14',
        tasks: [
          'Stéphane Maarek Udemy course: IAM + EC2 + EBS + ELB sections (1.75x speed)',
          'Note any timestamp where he says "exam" — use Udemy note tool',
          'AWS Skill Builder: hands-on labs for IAM and EC2',
          'Tutorial Dojo: IAM + EC2 practice questions',
        ]
      },
      {
        label: 'Week 3–4 — Storage + Databases',
        dates: 'Sep 15–28',
        tasks: [
          'Maarek course: S3, RDS, Aurora, DynamoDB, ElastiCache sections',
          'AWS Skill Builder: S3 and RDS labs',
          'Tutorial Dojo: Storage + Database practice questions',
          'Read S3 and RDS FAQ pages on AWS docs',
        ]
      },
      {
        label: 'Week 5–6 — Networking + Security',
        dates: 'Sep 29 – Oct 5',
        tasks: [
          'Maarek course: VPC, Route 53, CloudFront, SQS, SNS, all remaining sections',
          'AWS Skill Builder: VPC labs',
          'Tutorial Dojo: Full practice exam #1',
          'Tutorial Dojo: Full practice exam #2',
        ]
      },
      {
        label: 'Week 7 — Final Review + Exam',
        dates: 'Oct 6–12',
        tasks: [
          'Tutorial Dojo: Full practice exam #3',
          'Review all wrong answers against AWS docs',
          'Apply 50%-off voucher (earned from AI Practitioner pass) at checkout',
          'BOOK AND PASS EXAM ✅ Oct 12',
        ]
      },
    ]
  },
    ...
    weeks: [
      {
        ...
        dates: 'Oct 13–31',
        tasks: [
          'Maarek AWS Security Specialty course: IAM deep dive',
          'CloudTrail, CloudWatch, AWS Config — hands-on labs',
          'GuardDuty, Security Hub, Macie — understand each service deeply',
          'Tutorial Dojo SCS-C02: IAM + Logging practice questions',
          'Read AWS Security Best Practices whitepaper',
        ]
      },
      {
        label: 'Month 2 — Infrastructure + Data Protection',
        dates: 'Nov 1–30',
        tasks: [
          'KMS: key management, rotation, envelope encryption',
          ...
          'Tutorial Dojo SCS-C02: Full practice exam #1 + #2',
          'Review AWS Well-Architected Security Pillar whitepaper',
        ]
      },
      {
        label: 'Month 3 — Incident Response + Exam Prep',
        dates: 'Dec 1–15',
        tasks: [
          'Incident response on AWS: playbooks, automation with Lambda',
          'Forensics: EBS snapshots, VPC Flow Logs analysis',
          'Tutorial Dojo SCS-C02: Full practice exam #3 + #4',
          'Review all wrong answers — go deep on explanations',
          'BOOK AND PASS EXAM ✅',
        ]
      },
    ]
